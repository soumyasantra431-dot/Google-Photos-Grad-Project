/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c3b1d692f9fc92882e8fb4e45b225a51)
// Runtime types generated with workerd@1.20260916.1 2026-09-18 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	RECALL_RATE: RateLimit;
	GROQ_API_KEY: string;
	YOUTUBE_API_KEY: string;
	COLLECTION_TRIGGER_TOKEN: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GROQ_API_KEY" | "YOUTUBE_API_KEY" | "COLLECTION_TRIGGER_TOKEN">> {}
}
